...
<?php
			...
			$consulta = "SELECT NRC,nombremat,clave,aula,dias,hora,aula,cupos,creditos,nombre FROM clases INNER JOIN materias ON id_materia = NRC INNER JOIN horario ON id_horario = horario_id INNER JOIN usuarios ON id_usuario = usu_id";
