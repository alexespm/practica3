...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-09-2019 a las 21:03:03
...
(4, 'ADMINISTRACION DE SERVIDORES', 'pEy1W', 8, 40, 'X005'),
(5, 'ALGORITMIA', 'BYsw9', 8, 35, 'x003'),
(6, 'HIPERMEDIA', 'Nh32w', 8, 35, 'X010');
...
(5, 'Carlos', 'Jimenez', 'carlos_jim@alumnos.udg.mx', '3365637589', 'masculino', '46', 'jalisco', 3, 'alum2', 'alum2'),
(6, 'Javier', 'Diaz Curiel', 'ghtrhgeqrhjgb@trjhkj.com', '444638565', 'masculino', '32', 'khg', 2, 'mtro1', 'mtro1');
...
--
ALTER TABLE `materias`
  MODIFY `NRC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
